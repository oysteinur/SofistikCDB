...
class CLC_STAT(Structure):         # 13/LC:8  Statistics for a time series
   _fields_ = [
...
class CSAR_HOLE(Structure):        # 39/NR:202  Outer Boundary of Area
   _fields_ = [
         ('m_id', c_int),          #        identification
         ('m_ng', c_int),          #        edgeno     (31/NG)
         ('m_na', c_int),          #        startpoint (30/NA)
...
class CDSEL_IDS(Structure):        # 35/ID:3  Selection of elements by IDs
   _fields_ = [
         ...
         ('m_ids', c_int * 1024)   #        IDs used in selection
      ]
cdsel_ids = CDSEL_IDS()
...
class CSLVL_RES(Structure):        # 87/LC:+  Structural Storey Level Results
   _fields_ = [
         ...
         ('m_dxmax', c_float),     # [1003] extremal inter-storey drift in X (absolute value)
         ('m_dymax', c_float),     # [1003] extremal inter-storey drift in Y (absolute value)
...
class CDSLN_RFS(Structure):        # 126/DC:+  results of shear wall design
   _fields_ = [
         ('m_nr', c_int),          #        beamnumber
         ...
         ('m_r14', c_float),       # [1021] Reserved
         ('m_asb', c_float * 15 * 2), # [1021] transverse shear (A(1,i)) / confinement (A(2,i)) reinforcement
         ('m_lba', c_float),       # [1001] width of boundary element A (+Z)
         ('m_lbe', c_float),       # [1001] width of boundary element B (+Z)
